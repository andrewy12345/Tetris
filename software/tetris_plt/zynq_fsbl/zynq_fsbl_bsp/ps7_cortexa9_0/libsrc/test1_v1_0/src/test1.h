...
/**
 *
 * Write a value to a TEST1 register. A 32 bit write is performed.
 * If the component is implemented in a smaller width, only the least
 * significant data is written.
 *
 * @param   BaseAddress is the base address of the TEST1device.
...
/**
 *
 * Read a value from a TEST1 register. A 32 bit read is performed.
 * If the component is implemented in a smaller width, only the least
 * significant data is read from the register. The most significant data
 * will be read as 0.
 *
 * @param   BaseAddress is the base address of the TEST1 device.
 * @param   RegOffset is the register offset from the base to write to.
 *
 ...
 *
 * @param   baseaddr_p is the base address of the TEST1 instance to be worked on.
 *
 * @return
 *
